            ...
            <header className="header navbar navbar-expand-sm">
                ...
                <div className="nav-logo align-self-center">
                    <a className="navbar-brand" href="index.html">
                        <img alt="logo" src={Img90} /> <span className="navbar-brand-name">CORK</span>
                    </a>
                </div>
                ...
                <ul className="navbar-item flex-row nav-dropdowns">
                    <li className="nav-item dropdown language-dropdown more-dropdown">
                        <div className="dropdown custom-dropdown-icon">
                            <a
                                ...
                                aria-expanded="false"
                            >
                                <img src={caimg} className="flag-width" alt="flag" />
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                    ...
                    <li className="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                        ...
                        >
                            <div className="media">
                                <img src={Img90} className="img-fluid" alt="admin-profile" />
